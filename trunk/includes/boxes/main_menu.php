...
<?php
  ...
  $info_box_contents[] = array('text' => tep_draw_form('menu_11', tep_href_link(FILENAME_DEFAULT)) . tep_create_parameters(array('mPath'=>'11'), null, 'hidden_field') . tep_href_submit(BOX_MAINMENU_HOME, ($_POST['mPath']=='11'||$_POST['mPath']==''?'style="font-weight:bold;cursor:default" disabled':'')) . '</form><br>' .
                                         ...
                                         ($_POST['mPath']=='41'||$_POST['mPath']=='42'||$_POST['mPath']=='43'||$_POST['mPath']=='44'||$_POST['mPath']=='45'||$_POST['mPath']=='46'||$_POST['mPath']=='47'||$_POST['mPath']=='48'||$_POST['mPath']=='49'||$_POST['mPath']=='410'||$_POST['mPath']=='411'?'<br>' .
                                           ...
                                           tep_draw_form('menu_45', tep_href_link(FILENAME_ADMINISTRATION_CATEGORIES)) . tep_create_parameters(array('mPath'=>'45'), null, 'hidden_field') . '&nbsp;&nbsp;&nbsp;' . tep_href_submit(BOX_MAINMENU_ADMINISTRATION_CATEGORIES, ($_SESSION['employee']->is_administrator?($_POST['mPath']=='45'?'style="font-weight:bold;cursor:default" disabled':''):'style="cursor:default" disabled')) . '</form><br>' .
                                           tep_draw_form('menu_46', tep_href_link(FILENAME_ADMINISTRATION_ROLES)) . tep_create_parameters(array('mPath'=>'46'), null, 'hidden_field') . '&nbsp;&nbsp;&nbsp;' . tep_href_submit(BOX_MAINMENU_ADMINISTRATION_ROLES, ($_SESSION['employee']->is_administrator?($_POST['mPath']=='46'?'style="font-weight:bold;cursor:default" disabled':''):'style="cursor:default" disabled')) . '</form><br>' .
                                           tep_draw_form('menu_47', tep_href_link(FILENAME_ADMINISTRATION_EMPLOYEES)) . tep_create_parameters(array('mPath'=>'47'), null, 'hidden_field') . '&nbsp;&nbsp;&nbsp;' . tep_href_submit(BOX_MAINMENU_ADMINISTRATION_EMPLOYEES, ($_SESSION['employee']->is_administrator?($_POST['mPath']=='47'?'style="font-weight:bold;cursor:default" disabled':''):'style="cursor:default" disabled')) . '</form><br>' .
                                           tep_draw_form('menu_48', tep_href_link(FILENAME_ADMINISTRATION_EMPLOYEES_ROLES)) . tep_create_parameters(array('mPath'=>'48'), null, 'hidden_field') . '&nbsp;&nbsp;&nbsp;' . tep_href_submit(BOX_MAINMENU_ADMINISTRATION_EMPLOYEES_ROLES, ($_SESSION['employee']->is_administrator?($_POST['mPath']=='48'?'style="font-weight:bold;cursor:default" disabled':''):'style="cursor:default" disabled')) . '</form><br>' .
                                           tep_draw_form('menu_49', tep_href_link(FILENAME_ADMINISTRATION_UNITS)) . tep_create_parameters(array('mPath'=>'49'), null, 'hidden_field') . '&nbsp;&nbsp;&nbsp;' . tep_href_submit(BOX_MAINMENU_ADMINISTRATION_UNITS, ($_SESSION['employee']->is_administrator?($_POST['mPath']=='49'?'style="font-weight:bold;cursor:default" disabled':''):'style="cursor:default" disabled')) . '</form><br>' .
                                           tep_draw_form('menu_410', tep_href_link(FILENAME_ADMINISTRATION_TARIFFS)) . tep_create_parameters(array('mPath'=>'410'), null, 'hidden_field') . '&nbsp;&nbsp;&nbsp;' . tep_href_submit(BOX_MAINMENU_ADMINISTRATION_TARIFFS, ($_SESSION['employee']->is_administrator?($_POST['mPath']=='410'?'style="font-weight:bold;cursor:default" disabled':''):'style="cursor:default" disabled')) . '</form><br>' .
                                           tep_draw_form('menu_411', tep_href_link(FILENAME_ADMINISTRATION_TIMESHEETS)) . tep_create_parameters(array('mPath'=>'411'), null, 'hidden_field') . '&nbsp;&nbsp;&nbsp;' . tep_href_submit(BOX_MAINMENU_ADMINISTRATION_TIMESHEETS, ($_SESSION['employee']->is_administrator?($_POST['mPath']=='411'?'style="font-weight:bold;cursor:default" disabled':''):'style="cursor:default" disabled')) . '</form>':''));
