            ...
            <td class="item_entry">
              <table border="0" cellspacing="0" cellpadding="2" width="250" class="item_entry">
                <tr>
                  ...
                  <td width="10%" class="item_entry"><?php echo tep_draw_input_field('activity_travel_distance', '', 'size="1" maxlength="5" style="width: 35px"' . ($_POST['action']=='enter_data'||$_POST['action']=='save_data'?'':' disabled')); ?></td>
                  <td colspan="2" width="40%" class="item_entry"><?php echo tep_draw_input_field('activity_travel_description', '', 'size="1" maxlength="64" style="width: 100%"' . ($_POST['action']=='enter_data'||$_POST['action']=='save_data'?'':' disabled')); ?></td>
                </tr>
                <tr>
