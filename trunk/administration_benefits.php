        ...
        <table style="border-width:0px;width:100%;border-spacing:0">
          <tr>
            <td style="padding:0">
              <table style="border-width:0px;width:100%;border-spacing:0">
                <tr>
                  <td class="pageHeading"><?php echo HEADER_TEXT_ADMINISTRATION_BENEFITS; ?></td>
                ...
                <tr>
                  <td style="vertical-align:top;padding:0">
                    <table border="0" width="300pt" cellspacing="0" cellpadding="2" class="item_entry">
                      ...
                      <tr>
                        <td class="item_entry">
                          <?php echo tep_draw_form('employee_selection', tep_href_link(FILENAME_ADMINISTRATION_BENEFITS)) . tep_create_parameters(array(), array('mPath'), 'hidden_field');
                  ...
                  <td style="width:100%;vertical-align:top;padding:0">
                    <table border="0" width="100%" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="center">
                          <?php //require(DIR_WS_INCLUDES . 'benefit_entry.php'); ?>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <table border="0" width="100%" cellspacing="0" cellpadding="2" class="entryListing">
                            <tr style="vertical-align:top">
                              ...
                              <td class="entryListing-heading"><?php echo TEXT_BENEFITS_START_DATE.'<br>'.TEXT_BENEFITS_END_DATE; ?></td>
